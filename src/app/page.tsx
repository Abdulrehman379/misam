      ...
      <main className="pt-32 px-6 flex-1">
        ...
        {page==="home" && (
          <section className="text-center max-w-6xl mx-auto space-y-10">
            ...
            <img src="https://images.unsplash.com/photo-1501004318641-b39e6451bec6?auto=format&fit=crop&w=1400&q=80" alt="Nature green workspace" className="rounded-2xl shadow-2xl mx-auto w-full max-w-4xl"/>
